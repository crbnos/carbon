...
import { getSupplierContact } from "~/modules/purchasing/purchasing.service.server";
...
import { getPermissionsByEmployeeType } from "~/modules/users/users.service.server";
import type { Result } from "~/types";
import { path } from "~/utils/path";
import { insertEmployeeJob } from "../people/people.service.server";
