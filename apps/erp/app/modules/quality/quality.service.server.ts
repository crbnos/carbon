...
export const activateGauge = mcpTool(
  {
    classification: "WRITE"
  },
  async function activateGauge(gaugeId: string) {
...
export const deactivateGauge = mcpTool(
  {
    classification: "WRITE"
  },
  async function deactivateGauge(gaugeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("gauges")
...
export const deleteGauge = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteGauge(gaugeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("gauges").delete().eq("id", gaugeId);
  }
);

export const deleteGaugeCalibrationRecord = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteGaugeCalibrationRecord(
...
export const deleteGaugeType = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteGaugeType(gaugeTypeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("gaugeType").delete().eq("id", gaugeTypeId);
  }
);

export const deleteIssue = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteIssue(nonConformanceId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("nonConformance").delete().eq("id", nonConformanceId);
  }
);

export const deleteIssueAssociation = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteIssueAssociation(type: string, associationId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    switch (type) {
      case "items":
        return await client
...
export const deleteIssueType = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteIssueType(nonConformanceTypeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const deleteIssueWorkflow = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteIssueWorkflow(nonConformanceWorkflowId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const deleteRequiredAction = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteRequiredAction(requiredActionId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const deleteQualityDocument = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteQualityDocument(qualityDocumentId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("qualityDocument").delete().eq("id", qualityDocumentId);
  }
);

export const deleteQualityDocumentStep = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
  async function deleteQualityDocumentStep(qualityDocumentStepId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
...
export const deleteRisk = mcpTool(
  {
    classification: "DESTRUCTIVE"
  },
...
export const getIssueFromExternalLink = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueFromExternalLink(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("nonConformanceSupplier")
...
export const getGauge = mcpTool(
  {
    classification: "READ"
  },
  async function getGauge(gaugeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("gauges").select("*").eq("id", gaugeId).single();
  }
);

export const getGauges = mcpTool(
  {
    classification: "READ"
  },
...
export const getGaugesList = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugesList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getGaugeCalibrationRecord = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeCalibrationRecord(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const getGaugeCalibrationRecords = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeCalibrationRecords(
    args?: GenericQueryFilters & { search: string | null }
  ) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getGaugeCalibrationRecordsByGaugeId = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeCalibrationRecordsByGaugeId(gaugeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("gaugeCalibrationRecords")
      .select("*")
...
export const getGaugeTypesList = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeTypesList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("gaugeType")
...
export const getGaugeType = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeType(gaugeTypeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client.from("gaugeType").select("*").eq("id", gaugeTypeId).single();
  }
);

export const getGaugeTypes = mcpTool(
  {
    classification: "READ"
  },
  async function getGaugeTypes(
    args?: GenericQueryFilters & { search: string | null }
  ) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getIssue = mcpTool(
  {
    classification: "READ"
  },
  async function getIssue(nonConformanceId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("nonConformance")
      .select("*")
...
export const getIssues = mcpTool(
  {
    classification: "READ"
  },
...
export const getIssueWorkflow = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueWorkflow(nonConformanceWorkflowId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("nonConformanceWorkflow")
      .select("*")
...
export const getIssueAction = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueAction(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const getIssueActionTasks = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueActionTasks(id: string, supplierId?: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    let query = client
      .from("nonConformanceActionTask")
...
export const getIssueApprovalTasks = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueApprovalTasks(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
...
export const getIssueItems = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueItems(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("nonConformanceItem")
...
export const getIssueAssociations = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueAssociations(nonConformanceId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    const [
      items,
...
export const getIssueReviewers = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueReviewers(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
...
export const getIssueSuppliers = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueSuppliers(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("nonConformanceSupplier")
...
export const getIssueTasks = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueTasks(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return Promise.all([
      client
...
export const getIssueType = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueType(nonConformanceTypeId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("nonConformanceType")
      .select("*")
...
export const getIssueTypes = mcpTool(
  {
    classification: "READ"
  },
...
export const getIssueWorkflows = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueWorkflows(
    args?: GenericQueryFilters & { search: string | null }
  ) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getIssueWorkflowsList = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueWorkflowsList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("nonConformanceWorkflow")
...
export const getIssueTypesList = mcpTool(
  {
    classification: "READ"
  },
  async function getIssueTypesList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("nonConformanceType")
...
export const getQualityActions = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityActions(
    args?: GenericQueryFilters & { search: string | null }
  ) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getQualityDocument = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityDocument(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
...
export const getQualityDocumentSteps = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityDocumentSteps(qualityDocumentId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("qualityDocumentStep")
      .select("*")
...
export const getQualityDocumentVersions = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityDocumentVersions(qualityDocument: {
    name: string;
    version: number;
  }) {
    const client = getAuthClient<SupabaseClient<Database>>();
...
export const getQualityDocuments = mcpTool(
  {
    classification: "READ"
  },
...
export const getQualityDocumentsList = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityDocumentsList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return fetchAllFromTable<{
      id: string;
...
export const getQualityFiles = mcpTool(
  {
    classification: "READ"
  },
  async function getQualityFiles(id: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
...
export const getRequiredActionsList = mcpTool(
  {
    classification: "READ"
  },
  async function getRequiredActionsList() {
    const client = getAuthClient<SupabaseClient<Database>>();
    const { companyId } = AuthContextHolder.get();
    return client
      .from("nonConformanceRequiredAction")
...
export const getRequiredActions = mcpTool(
  {
    classification: "READ"
  },
...
export const getRequiredAction = mcpTool(
  {
    classification: "READ"
  },
  async function getRequiredAction(requiredActionId: string) {
    const client = getAuthClient<SupabaseClient<Database>>();
    return client
      .from("nonConformanceRequiredAction")
      .select("*")
...
export const insertIssueReviewer = mcpTool(
  {
    classification: "WRITE"
  },
  async function insertIssueReviewer(
...
export const updateIssueActionProcesses = mcpTool(
  {
    classification: "WRITE",
    schema: z.object({
      args: z.object({
  ...
  async function updateIssueActionProcesses(args: {
    actionTaskId: string;
    processIds: string[];
  }) {
    const client = getAuthClient<SupabaseClient<Database>>();
...
export const updateIssueStatus = mcpTool(
  {
    classification: "WRITE"
  },
  async function updateIssueStatus(update: {
    id: string;
...
export const updateIssueTaskStatus = mcpTool(
  {
    classification: "WRITE",
    schema: z.object({
      args: z.object({
  ...
  async function updateIssueTaskStatus(args: {
    id: string;
...
export const updateIssueTaskContent = mcpTool(
  {
    classification: "WRITE"
  },
  async function updateIssueTaskContent(args: {
    id: string;
...
export const updateQualityDocumentStepOrder = mcpTool(
  {
    classification: "WRITE"
  },
  async function updateQualityDocumentStepOrder(
    updates: {
      id: string;
      sortOrder: number;
      updatedBy: string;
...
export const updateRiskStatus = mcpTool(
  {
    classification: "WRITE"
  },
...
export const upsertGauge = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertGauge(
    gauge:
...
export const upsertGaugeCalibrationRecord = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertGaugeCalibrationRecord(
    ...
    if (
      ...
      const nextCalibrationDate = parseDate(
        gaugeCalibrationRecord.dateCalibrated
      )
        .add({
...
export const upsertGaugeType = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertGaugeType(
    gaugeType:
...
export const upsertIssue = mcpTool(
  {
    classification: "WRITE"
  },
...
export const upsertIssueWorkflow = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertIssueWorkflow(
...
export const upsertIssueType = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertIssueType(
    nonConformanceType:
      | (Omit<z.infer<typeof issueTypeValidator>, "id"> & {
          companyId: string;
          createdBy: string;
...
export const upsertRequiredAction = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertRequiredAction(
    requiredAction:
      | (Omit<z.infer<typeof issueTypeValidator>, "id"> & {
          companyId: string;
          active?: boolean;
...
export const upsertQualityDocument = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertQualityDocument(
    qualityDocument:
    ...
    if (copyFromId) {
      ...
      const workInstruction = (qualityDocument.data.content ??
        {}) as JSONContent;
...
export const upsertQualityDocumentStep = mcpTool(
  {
    classification: "WRITE"
  },
  async function upsertQualityDocumentStep(
    qualityDocumentStep:
...
export const upsertRisk = mcpTool(
  {
    classification: "WRITE"
  },
...
export async function getItemSamplingPlan(itemId: string) {
  const client = getAuthClient<SupabaseClient<Database>>();
  const { companyId } = AuthContextHolder.get();
...
export async function getInboundInspection(id: string) {
  const client = getAuthClient<SupabaseClient<Database>>();
  return (client as any)
    .from("inboundInspection")
    .select(
