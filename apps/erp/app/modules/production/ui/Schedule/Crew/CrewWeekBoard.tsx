...
/**
 * Week-basis manning: drag a person onto a station once and they're crewed
...
const CrewWeekBoard = ({
  ...
  const submitIntent = (payload: Record<string, string>) => {
    submit(payload, {
      ...
      navigate: false,
      fetcherKey: `crewweek:${payload.employeeId ?? "board"}`
    });
  };
