...
/**
 * The crew page uses two badge shapes on purpose, and the difference is what
 * the COLOUR means:
 *
 * - `CrewChip` (grid) — colour identifies the WORK CENTER, so the same station
 *   reads the same all the way down a week column. Callers pass the class.
 * - `CrewPill` (card) — colour identifies the METRIC (hours / free / overtime /
...
/** Crew card stat pill. Pass `tooltip` to explain what the number means —
