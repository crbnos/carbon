 ...
 */
export function CrewHoursModal({
  trigger,
  open: controlledOpen,
  onOpenChange,
  employeeId,
  ...
  const save = () => {
    ...
    if (!offDay) {
      const nextRows: CrewDayRowInput[] = draft
          ...
          <div className="divide-y divide-border/60 border-t border-border/60">
            ...
            <section className="flex flex-col gap-1.5 px-6 py-3.5">
              ...
              <Textarea
                value={noteDraft}
                rows={2}
                placeholder={t`Anything the crew should know`}
