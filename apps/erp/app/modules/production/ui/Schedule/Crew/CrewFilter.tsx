...
export type CrewFilterCategory = {
  key: string;
...
type CrewFilterProps = {
  categories: CrewFilterCategory[];
  onChange: (key: string, value: string | null) => void;
};

/**
 * The crew page's filter control: a "Filter" button opening a command menu
 ...
 */
export function CrewFilter({ categories, onChange }: CrewFilterProps) {
  const { t } = useLingui();
  ...
  const labelFor = (category: CrewFilterCategory) =>
