/**
 * Logic and styling shared by the crew views (Board, Matrix, Capacity, the
...
/** Inputs of the shift-hours ladder, as the crew loader ships them. */
...
/** Sortable column id of the Unassigned pool on the crew board. */
