...
// Storage Rules
// -----------------------------------------------------------------------------
// ERP-only admin CRUD for the Inventory → Storage Rules page. Cross-app queries
// (assignment loaders, list fetch for tab data, polymorphic assign/unassign)
// live in `@carbon/ee/rules` and are re-exported from this module's barrel.
