...
export async function updateIncludeMaterialsOnTravelerSetting(
  ...
  // TODO: drop the `as any` once the DB types include `includeMaterialsOnTraveler`
  // (regenerated by `pnpm db:migrate` after 20260723020305_include-materials-on-traveler).
  return (client.from("companySettings") as any)
