...
const ServiceHeader = () => {
  ...
  return (
    <>
      <div className="flex flex-shrink-0 items-center justify-between px-4 py-2 bg-background border-b border-border h-[50px] overflow-x-auto scrollbar-hide dark:border-none dark:shadow-[inset_0_0_1px_rgb(255_255_255_/_0.24),_0_0_0_0.5px_rgb(0,0,0,1),0px_0px_4px_rgba(0,_0,_0,_0.08)]">
        <VStack spacing={0} className="flex-grow">
          <HStack>
            <Link to={path.to.serviceDetails(itemId)}>
              <Heading size="h4" className="flex items-center gap-2">
                <span>{routeData?.serviceSummary?.readableIdWithRevision}</span>
              </Heading>
            </Link>
            <Copy
