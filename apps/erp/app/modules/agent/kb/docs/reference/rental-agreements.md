...
A refundable deposit is a customer deposit, not revenue. The agreement's **Deposits** section shows the **"Agreed deposit"** and the payments made against it. On a Draft or Active agreement, **"Record Deposit"** opens a customer receipt prefilled with the customer, the agreement, and the agreed amount.
