...
Without planning you'd reorder by hand. MRP nets demand against supply across the whole bill of materials, so a shortfall on a top-level satellite surfaces as the right quantity of every component, offset for its lead time — before you're caught short.
