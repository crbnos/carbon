...
notice's first affected item, so you land ready to pick a change type and edit. The standalone form leaves the
...
Submitting creates the change notice, attaches any affected items, and redirects to its detail page at
**"Draft"**.
