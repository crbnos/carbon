...
item row and leave the old one intact — which is why they auto-write a supersession so planning
knows to phase over. See `docs/reference/change-orders/supersession`.
