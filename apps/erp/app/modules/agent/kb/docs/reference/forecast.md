...
You enter projections under **Production → Demand Forecasts**, one part at a time, as a 52-week grid. Each cell is the quantity you expect to consume that week. Save it, and the next MRP run reads it.
