...
Flipping the switch on also emails every active employee of the company, so nobody's first warning is a locked screen. The message names the company, links straight to **Account → Security**, and tells people who already have an authenticator that nothing changes for them. It's sent once, on the off → on transition — toggling the switch back and forth doesn't mail everyone again, and turning enforcement *off* sends nothing.
