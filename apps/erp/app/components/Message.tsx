...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:!bg-muted group-[.is-user]:!text-foreground group-[.is-user]:!px-4 group-[.is-user]:!py-2 group-[.is-user]:max-w-fit group-[.is-user]:rounded-lg group-[.is-user]:rounded-br-none",
