import { LoadDataView } from "@carbon/onboarding/ui";
...
// State, counts, and mutations come from <HubProvider> in the layout.
export default function GetStartedLoadDataRoute() {
  return (
      ...
      <div className="w-full max-w-3xl mx-auto mb-6 rounded-xl border bg-card px-5 py-4 flex items-center gap-4">
        ...
        <div className="flex flex-col min-w-0 flex-1">
          ...
          <span className="text-sm text-muted-foreground">
            <Trans>
              Print count sheets, count the factory, and upload the filled
              sheets — Carbon drafts the count for your review.
            </Trans>
          </span>
        </div>
