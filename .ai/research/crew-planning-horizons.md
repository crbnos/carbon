# Crew planning horizons: day vs week vs month

> Naveen's ask (2026-08-01): supervisors should be able to plan a week and a
> month ahead on the crew page, not just today. Research: how real products
...
- Add `Month` to the crew page horizon: Capacity gains a Week | Month period
...
- `Copy week → next week(s)`: extend `copyCrewBoard` (day-grain today) with a
