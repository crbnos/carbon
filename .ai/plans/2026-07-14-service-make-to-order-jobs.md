...
- [ ] Task 6: Browser e2e — full service MTO flow with GL/psql assertions (handed to Brad 2026-07-14; fixtures seeded: process `proc_svc_e2e_assembly1` "Assembly", work center `wc_svc_e2e_bench1` "Bench 1" laborRate 50/overhead 10; browser session left authenticated)
