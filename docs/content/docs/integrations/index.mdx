...
Integrations are an **Enterprise** capability — on Carbon Cloud they're available on the **Business** and
**Partner** plans, except **Email** and **Exchange Rates**, which are on every plan. Self-hosted instances
aren't plan-gated.
