...
From the issue header you can also spin up a [change order](/docs/reference/change-orders) directly, carrying the issue across as its source, when the fix is an engineering change rather than a one-off disposition.
...
<Cards>
  ...
  <Card title="Change orders" href="/docs/reference/change-orders">
