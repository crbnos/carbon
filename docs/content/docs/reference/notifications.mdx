...
<FieldTable>
  ...
  <Field name="State changes & responses">A record's state moved in a way someone should know about: an approval was **requested**, **approved**, or **rejected**; a job **completed**; a change notice entered a new stage; a quote **expired**; a customer or supplier responded to a digital quote or supplier quote.</Field>
  ...
  <Field name="Workflow">A [workflow](/docs/reference/workflows) reached a **"Notify someone"** step. You write the subject and message yourself, and address it to a user or a group; it lands under the **General** topic with a **View details** button pointing at whichever record the step named.</Field>
</FieldTable>
