...
| --- | --- | --- |
| Mode | all | *Fixed Duration*, *Calculated*, or *Set on Receipt*. |
| Days | Fixed Duration | The shelf-life length added to the start event. |
| Trigger process | Fixed Duration (made) | The operation that starts the clock; blank means any operation. |
| Timing | Fixed Duration (made) | Whether the clock starts **Before** or **After** that process. |
| Calculate from BOM | Fixed Duration | Also cap the date at the earliest expiry of the consumed components. |
