---
title: Audit log
description: A per-company change history for key business entities. What gets recorded, how to view and filter it, and how old entries are archived.
plan: Business
---
...
Only users who can **update settings** can flip the toggle. Viewing the log needs the **view settings** permission. See [permissions and access](/docs/reference/permissions) for how the settings module maps to employee types.
...
<Cards>
  <Card title="Company settings" href="/docs/reference/company-settings">
    The company record and its feature toggles, including audit logging.
  </Card>
  <Card title="Permissions and access" href="/docs/reference/permissions">
    How the settings permission gates who can view and manage the log.
  </Card>
</Cards>
