...
<FieldTable>
  ...
  <Field name="Shift" type="reference">Their assigned work schedule (optional).</Field>
...
<Callout type="note">
Shifts are an employee-and-location concept, not a work-center one. A shift is never bound to a [work center](/docs/reference/work-centers); it schedules *people*, and a work center's load comes from the operations scheduled onto it, not from who's on shift.
</Callout>
