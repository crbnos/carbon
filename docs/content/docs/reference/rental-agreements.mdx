...
A refundable deposit is a <Term id="customer-deposit">customer deposit</Term>, not revenue. The agreement's **Deposits** section shows the **"Agreed deposit"** and the payments made against it; **"Record Deposit"** opens a prefilled customer receipt.
