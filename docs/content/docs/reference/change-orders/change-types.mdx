...
<Callout type="warning" title="Change notices operate on Parts only.">
...
show up in the change notice's [changes](/docs/reference/change-orders/lifecycle#review-the-changes-then-release)
as additions.
</Callout>
...
<Cards>
  ...
  <Card title="Methods & sourcing" href="/docs/reference/methods">
    Method versions and the Draft/Active/Archived states a change notice drives.
  </Card>
</Cards>
