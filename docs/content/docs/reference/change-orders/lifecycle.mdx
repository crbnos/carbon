...
<StatusFlow>
  ...
  <Status name="Cancelled" terminal>The off-ramp. The header's **"Cancel"** action closes the change order from any open stage without releasing anything. Locked like **"Done"**, but reversible: **"Reopen"** returns it to **"Draft"**.</Status>
</StatusFlow>
