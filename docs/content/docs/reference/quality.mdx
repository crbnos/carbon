...
The module also covers [**gauges and calibration**](/docs/reference/calibration) (with calibration-due tracking), **controlled documents** (versioned procedures and work instructions, with one active version at a time), **inspection documents** (ballooned FAI drawings and their characteristics), and a **risk register**.
