...
A **work center** is a place on the floor where operations run — a station, a machine, a cell — tied to a location. It carries the rates used to cost and schedule work, and performs one or more **processes** (the capabilities, like *cut* or *weld*).
