---
title: Workflow runs
description: Every firing of a workflow is recorded step by step. What the run list and run detail show, what each status means, how repeating steps are summarised, and how long history is kept.
plan: Business
---
...
<StatusFlow entity="workflowRun">
  ...
  <Status name="Skipped" terminal>It never started — the workflow was switched off, or a scheduled run came due too late, or its previous run was still going.</Status>
</StatusFlow>
