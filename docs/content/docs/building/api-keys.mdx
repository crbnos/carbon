...
<Callout type="note" title="Bearer at the edge, carbon-key underneath">
...
<Callout type="warn" title="Writes skip the service layer">
...
<Cards>
  ...
  <Card title="Data API" href="/api-reference">
    The generated endpoint catalogue for every table and view.
  </Card>
</Cards>
