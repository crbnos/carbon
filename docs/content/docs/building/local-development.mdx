...
| `crbn up --app erp,mes` | Run exactly these apps, skipping the picker. Repeatable; ids are `erp`, `mes`, `assembler`, `email`. |
| `crbn up --all` | Launch every app without the picker. |
