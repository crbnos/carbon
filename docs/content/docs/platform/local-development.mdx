...
description: Run the full Carbon stack locally with the crbn CLI — isolated per-worktree environments.
---
...
Your local settings live in the generated `.env.local`. See [Environment variables](/docs/platform/self-hosting/environment-variables) for the full configuration surface, and [Deployment](/docs/platform/deployment) to self-host on AWS.
