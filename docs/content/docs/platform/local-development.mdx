...
Your local settings live in the generated `.env.local`. See [Environment variables](/docs/platform/environment-variables) for the full configuration surface, and [Deployment](/docs/platform/deployment) to self-host on AWS.
