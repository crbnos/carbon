...
See [Environment variables](/docs/platform/environment-variables) for the full configuration surface, or the managed [AWS deployment](/docs/platform/deployment) for the cloud path.
