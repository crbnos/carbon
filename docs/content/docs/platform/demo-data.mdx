...
You are the employee on the floor: you get a job, a shift, people assignments and an open time card. Sales and storage rules, purchase approval rules with requests waiting for you, and customer portals are set up as well. The templates add no uploaded files, so [Documents](/docs/reference/documents) starts empty.
...
<Callout type="warn" title="Some companies can't take demo data">
...
<FieldTable>
  ...
  <Field name="Restore from a backup">Sets the new company up from an uploaded [backup](/docs/platform/backups) of another Carbon company environment. Carbon staff only.</Field>
...
<Callout type="info" title="Who can see the Demo Data page">
