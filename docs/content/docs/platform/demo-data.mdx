...
<FieldTable>
  ...
  <Field name="Restore from a backup">Sets the new company up from an uploaded Carbon [backup](/docs/platform/backups) of another company. Carbon staff only.</Field>
