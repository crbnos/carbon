...
See [Environment variables](/docs/platform/environment-variables) for the full configuration surface, or [Local development](/docs/platform/local-development) to run Carbon locally with the `crbn` CLI.
