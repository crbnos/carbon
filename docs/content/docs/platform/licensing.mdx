---
title: Licensing
description: "Carbon is dual-licensed: AGPLv3 for the Community edition, and a commercial license for Business features or for keeping your changes private."
---
...
<Diagram name="plans" caption="Starter runs the open core. Business and Enterprise add the Business features, the same packages/ee code a self-hosted commercial license unlocks." />
...
<Callout type="warn" title="Enterprise means two things on this page">
