...
Self-hosting (the [Docker + Caddy recipe](/docs/platform/self-hosting/docker-caddy)) runs the **Community** edition by default. A commercial license turns the same hardware into the **Enterprise** edition.
