...
<Diagram name="plans" caption="Every plan runs the same Community Edition code. Business and Enterprise add the Enterprise Edition code, which is what the Business features are. Enterprise runs the same software as Business, with services on top." />
