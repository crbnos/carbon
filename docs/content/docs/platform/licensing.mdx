...
<Diagram name="plans" caption="The Starter plan runs the same open core as Community Edition. The Business and Enterprise plans add the Business features, the packages/ee code that Enterprise Edition unlocks when you self-host." />
