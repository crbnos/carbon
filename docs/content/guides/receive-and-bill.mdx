...
Posting a receipt always updates inventory. The accounting entries — debit inventory or WIP, credit the goods-received-not-invoiced (GR/IR) clearing account — are written only when accounting is enabled for the company. Inventory and the general ledger advance on different switches.
</Callout>
