...
Carbon has a full Quote module with quantity-break pricing, so the 90-unit price could have been negotiated in [quote to cash](/guides/quote-to-cash) first. We'll pick the story up at the confirmed sales order, where the build truly begins.
</Callout>
