...
<Screenshot label="Job — production events" caption="Production events on a job; each posts labor, machine, and overhead to WIP at the work center's rates as it's logged." ratio="wide" />
