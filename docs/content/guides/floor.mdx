...
For parts that demand a paper trail, operators scan as they build. Under the hood, every physical thing — a serial, a batch, a lot — is a tracked entity. Scanning a child into the unit you're building records a tracked activity: the child is marked consumed, the unit is marked produced, and the link between them is permanent.
