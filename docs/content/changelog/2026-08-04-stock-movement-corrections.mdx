---
title: "Carbon agent, stock movement corrections, and notification preferences"
description: "An AI agent inside Carbon, corrections for any posted stock movement, per-topic notification preferences, and per-item serial number sequences."
date: "2026-08-04"
tags: ["agent", "inventory", "settings"]
---
