...
// `labels.generated` is deliberately NOT re-exported: `msg` is a build-time
// macro, so only a Vite-built consumer may import it, by its explicit deep path.
...
// `build.ts` is the generator's transform, not part of the package's API — the
// generator and check scripts import it by path.
