...
const PERCENT_COLUMN = /"[A-Za-z]*(?:Percent|Rate)"\s+[A-Za-z(,0-9\s)]*GENERATED\s+ALWAYS\s+AS/i;
...
export const noDerivedPercentColumn: ConformanceCheck = {
  ...
  provenance: {
    deprecates: "generated percent columns derived by division (rate = amount / subtotal)",
    replacedBy: "writable percent columns; amounts derive via applyRate in @carbon/utils",
    since: "2026-08-11"
  },
