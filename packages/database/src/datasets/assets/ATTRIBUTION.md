...
| `automotive_precision/models/pump-motor-assembly.glb` | Generated demo mesh (not a third-party STEP conversion) | Sankalp Thakur / Carbon seed | Original work for the demo dataset |
