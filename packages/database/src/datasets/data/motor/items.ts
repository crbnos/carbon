...
//   MTR- / STA- / ROT- / HSG- / SHF- / COIL- / LAM-STK- / PUMP- = Make Parts
//   MAG- / BRG- / ENC- / TRM-BLK / FAN- / SEAL- / FST- / NPL- / pump piece-parts = Buy Parts
//   MAT- = Materials
//   TL-  = Tools
//   SVC- = Services
//   CN-  = Consumables
...
export const BUY_PARTS: ItemSpec[] = [
  ...
  // Industrial pump piece-parts (Buy). Parents are Make below.
  {
...
export const METHODS: MakeMethodSpec[] = [
  ...
  },
  {
    readableId: "BASE-COUPLING-001",
    bom: [
      { component: "BASE-PLT-001", quantity: 1, order: 1 },
      { component: "CPLG-FLEX-001", quantity: 1, order: 2 },
      { component: "FST-M16-HEX", quantity: 4, order: 3 }
    ],
    bop: [
      {
        process: "Motor Assembly",
        workCenter: "Motor Assembly Bench",
        description: "Baseplate prep and coupling subassembly",
        order: 1,
        laborTime: 1.5
      }
    ]
  },
  {
    readableId: "PUMP-WET-END-001",
    bom: [
      { component: "SHAFT-PUMP-001", quantity: 1, order: 1 },
      { component: "IMP-SEMIOPEN-001", quantity: 12, order: 2 },
      { component: "DIFFUSER-STACK-001", quantity: 12, order: 3 },
      { component: "SLEEVE-STAGE-001", quantity: 12, order: 4 },
      { component: "SEAL-MECH-35MM", quantity: 1, order: 5 },
      { component: "BRG-6308-2RS", quantity: 2, order: 6 }
    ],
    bop: [
      {
        process: "Motor Assembly",
        workCenter: "Motor Assembly Bench",
        description: "Stack bowl stages on the shaft",
        order: 1,
        laborTime: 3.5,
        operationType: "Assembly"
      }
  ...
  },
  {
    readableId: "MOTOR-DRIVE-001",
    bom: [
      { component: "MOTOR-HOUSING-001", quantity: 1, order: 1 },
      { component: "STATOR-CORE-001", quantity: 1, order: 2 },
      { component: "ROTOR-CAGE-001", quantity: 1, order: 3 },
      { component: "WINDING-001", quantity: 1, order: 4 },
      { component: "ENDBELL-001", quantity: 2, order: 5 }
    ],
    bop: [
      {
        process: "Motor Assembly",
        workCenter: "Motor Assembly Bench",
        description: "Stator, rotor, windings and endbells",
        order: 1,
        laborTime: 4,
        operationType: "Assembly"
      }
  ...
  },
  {
    readableId: "PUMP-MOTOR-ASSY-001",
    bom: [
      { component: "MOTOR-DRIVE-001", quantity: 1, order: 1 },
      { component: "PUMP-WET-END-001", quantity: 1, order: 2 },
      { component: "BASE-COUPLING-001", quantity: 1, order: 3 }
    ],
    bop: [
      {
        process: "Motor Assembly",
        workCenter: "Motor Assembly Bench",
        description: "Couple motor to bowl assembly",
        order: 1,
        laborTime: 4,
        operationType: "Assembly"
      },
