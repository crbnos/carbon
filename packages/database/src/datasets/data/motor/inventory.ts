...
export const OPENING_STOCK: OpeningStockSpec[] = [
  ...
  { item: "SEAL-MECH-35MM", qty: 4, shelf: "A1-L3" },
  { item: "BRG-6308-2RS", qty: 12, shelf: "A1-L3" },
  { item: "IMP-SEMIOPEN-001", qty: 24, shelf: "A2-L1" },
  { item: "DIFFUSER-STACK-001", qty: 24, shelf: "A2-L1" },
  { item: "SLEEVE-STAGE-001", qty: 24, shelf: "A1-L1" },
  { item: "SHAFT-PUMP-001", qty: 3, shelf: "A2-L1" },
  { item: "MOTOR-HOUSING-001", qty: 3, shelf: "A2-L2" },
  { item: "STATOR-CORE-001", qty: 3, shelf: "A2-L2" },
  { item: "ROTOR-CAGE-001", qty: 3, shelf: "A2-L2" },
  { item: "WINDING-001", qty: 3, shelf: "A2-L2" },
  { item: "ENDBELL-001", qty: 6, shelf: "A2-L2" }
];
