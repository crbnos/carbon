...
Pure utility functions shared across all Carbon packages and apps. Covers accounting, arrays, BOM, dates, math, strings, status helpers, the storage/sales rule engine, URL manipulation, and more.
