    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            "group-[.toaster]:bg-blue-600 group-[.toaster]:text-white dark:group-[.toaster]:bg-blue-600 group-[.toaster]:border-blue-600 dark:group-[.toaster]:text-white group-[.toaster]:text-white",
          error:
