...
export const terms = {
  ...
  cogs: {
    ...
    href: "/docs/reference/accounting",
    // The spelled-out slug also resolves via `getEntry("cost-of-goods-sold")`
    // and `hasEntry("cost-of-goods-sold")` — both surface this canonical entry.
  ...
  // ── Cost centers ────────────────────────────────────────────────────────
  // Grounded: costCenter table (apps/erp/app/modules/accounting/accounting.models.ts L399);
  // owner is referenced in purchasing approval workflows when purchaseOrderApprovalsActive.
  "cost-center": {
    term: "Cost center",
    definition:
